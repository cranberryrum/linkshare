...
DROP POLICY IF EXISTS "Anyone can read non-expired links by id" ON links;
DROP POLICY IF EXISTS "Anyone can insert their own link" ON links;
DROP POLICY IF EXISTS "Creator can update their own link" ON links;
DROP POLICY IF EXISTS "Creator can delete their own link" ON links;
